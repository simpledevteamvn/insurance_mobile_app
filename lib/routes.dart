...
import 'package:shop_app/screens/quotation/quotation_result_screen.dart';
...
final Map<String, WidgetBuilder> routes = {
  ...
  QuotationSearchScreen.routeName: (context) => QuotationSearchScreen(),
  QuotationDetailScreen.routeName: (context) => QuotationDetailScreen(),
  ToyotaInfoSearchScreen.routeName:(context) => ToyotaInfoSearchScreen(),
  ToyotaInfoResultScreen.routeName:(context) => ToyotaInfoResultScreen(),
};
